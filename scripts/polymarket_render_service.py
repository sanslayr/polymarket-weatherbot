...
def _build_polymarket_section(
    ...
    best_lead_min = _lp_float("best_lead_min", 0.30)
    best_weather_min = _lp_float("best_weather_min", 0.54)
    alpha_cheap_ask_max = _lp_float("alpha_cheap_ask_max", 0.14)
    alpha_cheap_spread_max = _lp_float("alpha_cheap_spread_max", 0.08)
    alpha_cheap_weather_min = _lp_float("alpha_cheap_weather_min", 0.22)
    alpha_cheap_score_min = _lp_float("alpha_cheap_score_min", 0.28)
    alpha_cheap_edge_min = _lp_float("alpha_cheap_edge_min", 0.15)
    alpha_mid_ask_max = _lp_float("alpha_mid_ask_max", 0.18)
    alpha_mid_spread_max = _lp_float("alpha_mid_spread_max", 0.06)
    alpha_mid_weather_min = _lp_float("alpha_mid_weather_min", 0.48)
    alpha_mid_score_min = _lp_float("alpha_mid_score_min", 0.36)
    alpha_mid_edge_min = _lp_float("alpha_mid_edge_min", 0.18)
