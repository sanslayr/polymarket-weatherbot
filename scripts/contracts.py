...
POSTERIOR_FEATURE_VECTOR_SCHEMA_VERSION = "posterior-feature-vector.v4"
QUALITY_SNAPSHOT_SCHEMA_VERSION = "quality-snapshot.v2"
WEATHER_POSTERIOR_CORE_SCHEMA_VERSION = "weather-posterior-core.v4"
WEATHER_POSTERIOR_SCHEMA_VERSION = "weather-posterior.v1"
REPORT_FOCUS_SCHEMA_VERSION = "report-focus.v1"
ANALYSIS_SNAPSHOT_SCHEMA_VERSION = "analysis-snapshot.v10"
